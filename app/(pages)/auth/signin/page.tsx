...
const Signin: FunctionComponent = () => {
   ...
   */
  const handleLogin = (e: any, provider: string) => {
    e.preventDefault();
    signIn(provider, { callbackUrl: "/" });
  };

  return (
    <main className="flex h-[100svh] w-screen flex-col items-center justify-center gap-[1em]">
      <Button
        className="flex w-full items-center justify-center gap-2 rounded-md bg-white p-4 text-black shadow-md"
